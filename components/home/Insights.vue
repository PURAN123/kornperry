    ...
    <div class="text-white text-center flex flex-col items-center font-semibold bg-primary px-5 max-w-7xl mx-auto">
        ...
        <div class="py-10">
            ...
            <div class="flex justify-center items-center gap-6 flex-wrap">
                ...
                <button class=" px-1 rounded-md py-2 border border-textPrimary px-4 hover:bg-primary hover:text-white hover:-translate-y-2 transition-all duration-300 ease-in-out">My next career move</button>
            </div>
