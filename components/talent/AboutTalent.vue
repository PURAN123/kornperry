<template>
  <div class="py-16 px-8 md:px-16 bg-gray-50">
    <div class="max-w-5xl mx-auto">
      ...
      <div class="lg:px-40 px-0 sm:px-20">



      <!-- Main content -->
      <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-green-800 mb-8">
        Whether it's 1 person or 35,000 people, find the people you need to grow your business.
      </h2>
      ...
      <div class="space-y-6">
        ...
        <p>
          Our talent acquisition specialists work with you at each stage of the talent journey. We handle more than just recruiting. We connect the dots between talent recruitment and talent management. As part of a global consultancy, we can support your team with everything from talent acquisition through DEI, talent analytics and more. No matter what your talent needs are, our experts help you develop a strategy that identifies and attracts the right people to achieve your goals.
        </p>
